...
export default {
    ...
    watch: {
        /*
         * Watches field properties for any change and refreshes resources.
         */
        currentField: {
            handler(newValue) {
                if (!this.currentField.searchable) {
                    this.getAvailableResources();
                }
                this.getAttachedResources();
            },
            ...
            Nova.request()
                .get(`/nova-api/armincms/${this.resourceName}/nonattachable/${this.field.resourceName}`, {
                    params: {
                        ...
                        filters: this.currentField?.attachableFilters,
                    },
                })
                .then(({ data }) => {
